...
(function attachEditorVisualTools() {
  ...
  function afterSceneEditorMiniGraph() {
  ...
  if (Editor.hooks && typeof Editor.hooks.after === 'function') {
    ...
    console.warn('[editor-visual-tools] Editor.hooks missing — mini-graph extensions skipped');
  }
})();

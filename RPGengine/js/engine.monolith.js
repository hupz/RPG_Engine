    ...
    return `
      <button type="button" class="campaign-card" data-campaign-id="${this.escapeAttr(campaign.id)}"
        ...
        <div class="campaign-card-body">
          <span class="campaign-card-badge">${this.escapeHtml(campaign.badge)}</span>
          <span class="campaign-card-title">${this.escapeHtml(campaign.title)}</span>
          <span class="campaign-card-sub">${this.escapeHtml(campaign.subtitle)}</span>
          <span class="campaign-card-desc">${this.escapeHtml(campaign.description)}</span>
          ${saveHint}
